...
import { ItemSortColumn, SortDirection } from "./types";
...
export const ItemsGetInQuerySchema = z.object({
  ...
  categories: z
    ...
    .pipe(z.array(z.string()).optional()), // Упростил для гибкости
  needsRevision: z
    .string()
    .optional()
    .transform((val) => val === "true" || val === "1")
    .pipe(z.boolean().optional().default(false)),
  // ИСПРАВЛЕНО: Добавили "price" в список разрешенных полей
